...
@export var mission_id = "mission7"
 
func _ready():
	print(" called for mission: " + mission_id)
...
func set_active(is_active: bool):
	...
	if sprite:
		var texture_path = "res://mission_sprites/level3_car.png" if is_active else "res://mission_sprites/level3_car_grey.png"
